        ...
        conn.onclose = function(evt) {
          ...
          if (instance.onDisconnect) {
            ...
            instance.onDisconnect(
              new Error(_boffClosed ? NETWORK_USER_TEXT : NETWORK_ERROR_TEXT + ' (' + code + ')'),
              code
            );
          }
        ...
        if (poller.readyState == XDR_DONE) {
          if (poller.status == 201) {
            ...
            if (instance.onDisconnect) {
              ...
              let text =
                poller.responseText || (_boffClosed ? NETWORK_USER_TEXT : NETWORK_ERROR_TEXT);
...
Tinode.prototype = {
   ...
   */
  createMessage(topic, data, noEcho) {
...
Topic.prototype = {
  ...
  _updateCachedUser(uid, obj, requestUpdate) {
...
LargeFileHelper.prototype = {
   ...
   */
  upload(file, onProgress, onSuccess, onFailure) {
    if (!this._authToken) {
   ...
   */
  download(relativeUrl, filename, mimetype, onProgress) {
